...
meshFilePath ='geomRect_modified.msh'; % A COMPLETER
...
affiche(Us(:,2), Numtri, Coorneu);
affiche(Us(:,80), Numtri, Coorneu);
affiche(Us(:,150), Numtri, Coorneu);
